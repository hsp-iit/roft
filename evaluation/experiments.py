...
class Experiments():
    ...
    def __init__(self):
        ...
        self.add_algorithm_to_experiment('exp_ycbvs_ours_time', 'ours', masks_set = 'mrcnn_ycbv_bop_pbr', of_set = 'nvof_1_slow', pose_set = 'dope', dataset = 'ycbv_synthetic')
        ...
        # HO-3D comparison
        self.add_algorithm_to_experiment('exp_ho3d_nvof_comparison', 'ours', masks_set = 'mrcnn_ycbv_bop_pbr', of_set = 'nvof_2_slow', pose_set = 'dope', dataset = 'ho3d')
        self.add_algorithm_to_experiment('exp_ho3d_nvof_comparison', 'ours', masks_set = 'mrcnn_ycbv_bop_pbr', of_set = 'nvof_1_slow', pose_set = 'dope', dataset = 'ho3d', label = 'ours_nvof_1')
